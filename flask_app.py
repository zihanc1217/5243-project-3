"""
A/B Test Web Application — Flask implementation (legacy / alternative)
======================================================================

The canonical application for this project is the Shiny-for-Python app in
``app.py``.  This Flask version is kept around as a reference / alternative
deployment target (Render, Heroku, Fly, etc.) and shares the same SQLite
schema (``events`` table) so ``analysis.py`` and ``simulate.py`` work
